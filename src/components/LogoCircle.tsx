 ...
 */
export function LogoCircle({ className, imgClassName, version = "60" }: LogoCircleProps) {
  return (
    <div 
      className={cn(
    ...
    >
      <img 
        ...
        className={cn(
          "w-[110%] h-[110%] max-w-none object-contain pointer-events-none select-none",
          "relative -left-[2.5%] top-[0.5%]",
          imgClassName
        )}
      />
    </div>
